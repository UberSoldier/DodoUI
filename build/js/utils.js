...
layui.define(['layer'], function(exports) {
    ...
    var utils = {
        ...
        loadHtml: function(url, callback) {
            ...
            $.ajax({
                ...
                error: function(xhr, err, msg) {
                    ...
                    result = m.replace('{{msg }}', '<i class="layui-icon" style="font-size:70px;">&xe69c;</i> 未知错误.');
                },
        ...
        keyWordHightlight: function(o, flag, rndColor, url) {
            /// <summary>
            ...
            for (var i=0;i < o.childNodes.length;i++) {
                ...
                if (o_.nodeType == 1) {
                    this.keyWordHightlight(o_, flag, rndColor, url);
            ...
            function fEleA(text, flag) {
                ...
                if (url) {
                    ...
                    str = text.replace(re, '<span' + style + '>$1</span>');// 不加链接是显示
                }
                o.innerHTML = str;
                return o;
            }
